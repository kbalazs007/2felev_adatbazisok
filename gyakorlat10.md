...
```js
rpush tantartgyak "programozas alapjai" matematika adatbaziskezeles
rpush "operacios rendszerek" //ezzel eddig létrehoztuk
...
```js
KEYS *a* //TILOS!!! NAGYON LETERHELI A SZERVERT

//HELYETTE EZT KELL, A 200 az az h kb mennyi lesz és ehhez a számhoz optimalizál(bármit is jelentsen ez)
